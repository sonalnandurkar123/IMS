		    ...
		    <div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					  <div class="x_title">
						...
						<a href="exam_conducted.php" class="btn btn-primary submit" >Add list with Marks</a>
									...
									$row_exam=$stmt1->fetchAll(PDO::FETCH_ASSOC);
												...
												?>
													...
													<td>
														...
														<a href="exam_details?id=<?php echo $row_exam[$f]['exam_details_id'];?>" class="btn btn-primary">Add Marks</a>
														<a href="list_exam_conducted?id=<?php echo $row_exam[$f]['exam_details_id'];?>" class="btn btn-primary" onclick="return confirm('Are you sure you want to delete this?');">Delete</a>
													</td>
												</tr>
												<?php
													}
